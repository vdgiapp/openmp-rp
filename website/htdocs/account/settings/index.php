<?php
    ...
    if(isset($_SESSION['logged'])) {
        ...
        if($_SESSION['logged'] == 1) {
            ...
            if($rdata['Online'] == 1) return include("location: ../../auth/logout.php");
...
<div class="container">
    ...
    <div class="row vertical-gap text-white">
        ...
        <div class="col-lg-2 nk-box-2"> <!--bg-dark-2-->
            <big style="font-size: 18px;"><strong>SID :</strong>&ensp;
                <?php echo $rdata['SID'];?>
            </big>
        </div>
        ...
        <div class="col-lg-4 nk-box-2">
            <big style="font-size: 18px;"><strong>Ngày sinh :</strong>&ensp;
                <?php
                    if($rdata['Birthday'] == '') echo 'Chưa đặt.';
                    else {
        ...
        <div class="col-lg-4 nk-box-2">
            <big style="font-size: 18px;"><strong>Mật khẩu cấp 2 :</strong>&ensp;
                <?php
                    if($rdata['Password2'] == '') echo 'Chưa đặt';
                    else echo '******';
                ?>
            </big>
        </div>
        ...
        <div class="col-lg-6 nk-box-2">
            <big style="font-size: 18px;"><strong>Lần cuối:</strong>&ensp;
                <?php
                    sscanf($rdata['LastTimeLogged'], "%02d %02d %02d %02d %02d %04d", $l1, $l2, $l3, $l4, $l5, $l6);
        ...
        <div class="col-lg-6 nk-box-2">
            <big style="font-size: 18px;"><strong>Ngày đăng ký :</strong>&ensp;
                <?php
                    sscanf($rdata['DateCreated'], "%02d %02d %04d", $l1, $l2, $l3);
                    echo $l1.'/'.$l2.'/'.$l3;
                ?>
            </big>
        </div>
    ...
    <div class="nk-copyright">
        <div class="container">
            <div class="nk-copyright-left">
                <a href="http://localhost">GTA Playground Vietnam</a>
            </div>
