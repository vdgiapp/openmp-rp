...
#define HOUSE_LOCKER_SLOT1 			(12)
#define HOUSE_LOCKER_SLOT2			(HOUSE_LOCKER_SLOT1 + 6)
#define HOUSE_LOCKER_SLOT3			(HOUSE_LOCKER_SLOT2 + 18)
...
new const Float:arrHouseInteriors[][ENUM_HOUSE_INT] = {
//	IntID	Int X			Int Y			Int Z			Int A		Locker X		Locker Y		Locker Z
